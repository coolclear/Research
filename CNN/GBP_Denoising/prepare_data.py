...
def main():
    ...
    # save to pickle
    f = open('./{}.pkl'.format('GBP_2'), 'wb')
    pkl.dump((X_train_gbp, y_train), f, -1)
    pkl.dump((X_test_gbp, y_test), f, -1)
    f.close()

    # visualization
    grid_plot([10, 10], X_train_ori[:100], 'Original_CIFAR10_2', './Visualization', 'Examples_Ori_CIFAR10_2')
    grid_plot([10, 10], X_train_gbp[:100], 'GBP_CIFAR10_2', './Visualization', 'Examples_GBP_CIFAR10_2')
