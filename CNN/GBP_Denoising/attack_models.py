...
def main(type="Resnet", dataset="CIFAR10"):
    ...
    with tf.Session() as sess:
        ...
        if type == 'End2End':
            _, tf_model = \
                prepare_GBP_End2End(num_classes, inputT=x, checkpoint_dir="./{}_{}/Model.ckpt".format(dataset, type), sess=sess)
        else:
            _, tf_model = \
                prepare_Resnet(num_classes, inputT=x, checkpoint_dir="./{}_{}/Model.ckpt".format(dataset, type), sess=sess)
